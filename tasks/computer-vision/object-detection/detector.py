...
if __name__ =="__main__":
    ...
    keras_model_path = sys.argv[2] if len(sys.argv) > 2 else 'models/yolov3-spp.h5'
    ...
    dataset = sys.argv[4] if len(sys.argv) > 4 else 'data/coco.data'
    if mode =="video":
        print("video")
        ...
        print("image")
        item = sys.argv[5] if len(sys.argv) > 5 else 'data/horses.jpg'
